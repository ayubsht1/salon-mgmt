...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([serviceItems, appointmentItems]) => {
  ...
  async function createService(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const created = await api<Service>(
        "/services/",
        {
          method: "POST",
          body: JSON.stringify({
      ...
      setError(
        reason instanceof Error ? reason.message : "Unable to add service.",
      );
    } finally {
      setSaving(false);
    }
  ...
  async function toggleService(service: Service) {
    ...
    try {
      ...
      setError(
        reason instanceof Error ? reason.message : "Unable to update service.",
      );
    }
  }
      ...
      <main>
        ...
        <section className="section shell">
          <div className="empty">
            ...
            <p>Sign in with your staff account to access the salon portal.</p>
  ...
  if (!user.is_staff)
    return (
      <main>
        ...
        <section className="section shell">
          <div className="empty">
            <h2>This area is for staff</h2>
            <p>
              Your customer account does not have permission to manage the
              salon.
            </p>
  ...
  return (
    <main>
      ...
      <section className="section shell page-intro">
        <p className="eyebrow">Studio portal</p>
        <div className="page-title-row">
          <h1>Good morning, {user.first_name}</h1>
          <button className="primary-button" onClick={() => setFormOpen(true)}>
            Add service <span>+</span>
          </button>
        </div>
        <p className="hero-text">
          Manage today&apos;s appointments and keep your service menu current.
        </p>
      </section>
      {notice && (
      ...
      {error && (
        <div className="notice shell admin-error">
          {error}
      ...
      <section className="admin-grid shell">
        <div className="admin-panel">
          ...
          {loading ? (
            ...
            <p className="muted">No appointments have been booked yet.</p>
          )}
        </div>
        <div className="admin-panel">
          <div className="panel-heading">
